...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run the InfoMax auditory model simulation.")
    parser.add_argument("--quick", action="store_true", help="Run a reduced quick experiment.")
    parser.add_argument("--no-plot", action="store_true", help="Disable cost plot generation.")
    parser.add_argument("--inputs", type=int, default=40, help="Number of input neurons.")
    parser.add_argument("--outputs", type=int, default=400, help="Number of output neurons.")
    parser.add_argument("--results-path", type=str, default="Results", help="Results folder.")
